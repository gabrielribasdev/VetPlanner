...
import { BotaoSubmit, FichaContainer, GridCampos, StyledFieldset, StyledForm, StyledInput, StyledLegend, StyledSelect,TituloFicha } from "../styles/cadastros-style";
    ...
    const handleSubmitTutor = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                showToast(
                    `Erro ao cadastrar o tutor: ${result.message}`,
                    "error"
                );
            }
        } catch (err) {
    ...
    const handleSubmitPet = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                showToast(
                    `Erro ao cadastrar o pet: ${result.message}`,
                    "error"
                );
            }
        } catch (err) {
                ...
                <Tabs selectedTab={activeTab} onChange={setActiveTab}>
                    <Tab label="Cadastro do Tutor">
                        <StyledForm onSubmit={handleSubmitTutor}>
                            ...
                            <BotaoSubmit
                                type="submit"
                                disabled={!isTutorFormValid || loadingTutor}
                                isValid={isTutorFormValid}
                    ...
                    <Tab label="Cadastro do Pet">
                        <StyledForm onSubmit={handleSubmitPet}>
                            ...
                            <BotaoSubmit
                                type="submit"
                                disabled={!isPetFormValid || loadingPet}
                                isValid={isPetFormValid}
                                loading={loadingPet}
                            >
                                {loadingPet ? (
                                    <div className="spinner" />
